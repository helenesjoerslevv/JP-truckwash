...
<section class="hero-home">
    ...
    <div class="hero-home-content">
        ...
        <a href="dienstleistungen" class="btn btn-primary"><?php pll_e("Se vores ydelser")?></a>
    </div>
</section>
    ...
    <?php if ($image && !empty($service_categories[$index])): ?>
        <div class="service-item">
            ...
            <div class="overlay">
                ...
                <?php if ($index == 0): ?>
                    <a href="<?php echo esc_url(home_url('/waschkueche')); ?>" class="service-category"><?php echo esc_html($service_categories[$index]); ?></a>
                <?php elseif ($index == 1): ?>
                    <a href="<?php echo esc_url(home_url('/sanfte-loesung')); ?>" class="service-category"><?php echo esc_html($service_categories[$index]); ?></a>
                <?php elseif ($index == 2): ?>
                    <a href="<?php echo esc_url(home_url('/kontakt-2')); ?>" class="service-category"><?php echo esc_html($service_categories[$index]); ?></a>
                <?php endif; ?>
            </div>
        </div>
    <?php endif; ?>
